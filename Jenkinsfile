...
node {
  withEnv(['AZURE_SUBSCRIPTION_ID=9a86476e-b022-4aa8-9372-dab324cf625d',
    ...
    stage('deploy') {
      ...
      // login Azure
      withCredentials([usernamePassword(credentialsId: '7454a61d-a99c-45d0-82e1-321eea3031f4', passwordVariable: 'd2v8Q~gpVsK4-.FKhSgGIjXXlmLkqKb4Ijo7gcnV', usernameVariable: 'AzureServicePrincipal')]) {
       sh '''
